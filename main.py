...
5. 이전 교재들의 학습 이력 설명:
   ...
   - 쉬운 표현 사용
   - '교재 테스트결과' 필드 분석:
     * '통과': "테스트에서 좋은 성적을 받아 다음 교재로 넘어갔습니다."
     * '재시험': "현재 테스트 재응시를 준비하고 있습니다."
     * '재시험통과': "재시험에서 실력을 보여주어 다음 교재로 넘어갔습니다."
   - 테스트 결과에 따른 조언:
     * '통과' 시: "지금처럼만 열심히 공부하면 될것같아요."
     * '재시험' 시: "틀린 문제를 꼼꼼히 복습하고 재시험 준비를 잘하면 좋은 결과가 있을 거예요."
     * '재시험 통과' 시: "재시험을 통과한 만큼, 앞으로는 처음부터 더 꼼꼼히 공부하면 더 좋은 결과가 있을것 같습니다."
