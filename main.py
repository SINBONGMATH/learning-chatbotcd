...
5. 이전 교재들의 학습 이력 설명:
   - 완료된 교재는 확정적 표현 사용 (예: "익혔습니다", "공부했습니다", "끝냈습니다")
   - 추측성 표현 사용 금지 (예: "익혔겠죠", "했을 거예요" 등은 사용하지 않음)
   - 어려운 표현 사용 금지:
     * 사용하지 않을 표현: "착수했다", "수행했다", "진척되었다"
     * 사용할 표현: "시작했다", "했다", "진행했다", "공부했다"
   - 구체적 기간과 함께 명확한 성과 언급 (예: "2024년 12월 20일부터 2025년 1월 20일까지 가우스 중2-1 (1)권을 공부했습니다.")
